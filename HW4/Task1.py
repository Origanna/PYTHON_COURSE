...
for elem in all_elems:
    # Проверяем, если элемент не добавлен ранее и присутствует во всех трёх списках
...
new_elems_1_set = set(array_1) & set(array_2) & set(array_3) # Пересечение трёх множеств
